...
%
%       Identification and location estimate of particles in a
%       single frame based on locating the brightest pixels
%
...
%   A rough estimate of the threshold value can be determined
%   by the maximum pixel value in the bandpass filtered image
%   A good estimate of the threshold value is about 
%   40% - 60% of the maximum pixel value.
